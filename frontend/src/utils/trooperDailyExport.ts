...
function addHeader(page: PdfPage, title: string, subtitle: string) {
  ...
  page.commands.push(textLine(MARGIN, PAGE_HEIGHT - 38, 'Blueline', 10, 'F2', '1 1 1'));
...
function addFooter(page: PdfPage, totalPages: number) {
  ...
  page.commands.push(textLine(MARGIN, 20, 'Generated by Blueline', 8, 'F1', MUTED));
...
<body>
  <h1>Blueline Trooper Daily Reports</h1>
